    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            let except_word = [
                ...
                "hold", "result", "art", "become", "tomorrow", "keep", "weather", "’", "home", "game", "team", "event", "second", "however", "higher", "wang", "gangwon-do", "dr.", "end"
            ];
...
function wordCloud(s, c) {
    ...
    function draw(words) {
        ...
        var my_gradient = d3.createLinearGradient(0, 0, 0, 170);
